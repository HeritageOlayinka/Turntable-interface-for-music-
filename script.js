...
let dragging;
let interval;
let albums = ['He3T7liqb9Q', 'OuNCysX4TMk'];
...
function onPlayerReady(event) {
  ...
  document.querySelector('#track').addEventListener('click', () => {
    let url = prompt('Type in a YouTube URL. An example of a youtube URL is "https://www.youtube.com/watch?v=dQw4w9WgXcQ" :', 'https://www.youtube.com/watch?v=' + id);
